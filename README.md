...
```bash
curl -fsSL https://raw.githubusercontent.com/gracefish/codex-history-manager/main/scripts/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/gracefish/codex-history-manager/main/scripts/uninstall.sh | bash
```
